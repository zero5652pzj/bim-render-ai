...
本文档定义了消息删除功能的具体需求和验收标准，包括单个消息删除和清空对话消息的功能。
...
- [对话管理](../conversation-management/spec.md) - 删除对话的功能
- [用户认证](../user-management/spec.md) - 确保用户只能删除自己的消息

## 参考资料

- `frontend/src/stores/message.ts` - 消息 Store 实现
